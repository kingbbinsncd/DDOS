...
TOKEN = "7356158342:AAH2g1CwNupOVN-x8KCxtBLpY2nQxrMI_0I"
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner:  @KINGVIPHACK77* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @kingviphack77* 🙏"  # Contact owner message
    else:
