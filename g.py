...
TOKEN = '7686025154:AAGjpDJSlfCAjzyyUcAKKXSOit_9UNTFZhk'
MONGO_URI = 'mongodb+srv://shapilov89:lelaudalele@abhishek.wggaw.mongodb.net'
FORWARD_CHANNEL_ID = -1002326896418
CHANNEL_ID = -1002326896418
error_channel_id = -1002326896418
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(chat_id, "*Please contact owner to buy it @YTABHIA2Z 😘🥰*", parse_mode='Markdown')
        return
...
def attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "TUM CHUDAI 💦 NHI KR SAKTE 😥. Please contact Owner. @KINGVIPHACK77 🙏")
            return
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*CHUDAI 💦 SURU KRO PRABHU:*", reply_markup=markup, parse_mode='Markdown')
